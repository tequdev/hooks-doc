...
| [`hook_pos`](hook_pos.md) | Return this hook's zero-based position within the hook chain. <!-- evidence: `HookAPI::hook_pos()` returns `hookCtx.result.hookChainPosition` (`src/xrpld/app/hook/detail/HookAPI.cpp:1794-1797`). --> |
